<template>
  <div class="question-management">
    <div class="toolbar">
      ...
      <div class="filters">
        <el-select v-model="filterType" placeholder="题目类型" clearable>
          <el-option label="加减运算" value="AddAdnSub" />
    ...
    <!-- 添加题目对话框 -->
    <el-dialog v-model="showAddDialog" title="添加题目" width="500px">
      <el-form :model="newQuestion" :rules="questionRules" ref="questionFormRef">
        <el-form-item label="题目内容" prop="content">
          <el-input v-model="newQuestion.content" placeholder="请输入题目内容" />
        </el-form-item>
        
        <el-form-item label="题目类型" prop="type">
          <el-select v-model="newQuestion.type" placeholder="请选择类型">
            <el-option label="加减运算" value="AddAdnSub" />
            <el-option label="乘除运算" value="MulAndDiv" />
            <el-option label="混合运算" value="Mixed" />
          </el-select>
        ...
        <el-form-item label="答案" prop="answer">
          <el-input-number v-model="newQuestion.answer" :precision="2" />
        </el-form-item>
      </el-form>
      
      <template #footer>
        <el-button @click="showAddDialog = false">取消</el-button>
        <el-button type="primary" @click="handleAddQuestion" :loading="adding">
          确认添加
        </el-button>
      </template>
    </el-dialog>
